...
def seed():
	if len(ses.query(CardSet).all()) <= 0:
		...
		s14 = CardSet(name="XY - Generations", setName="GEN", standard=False, shortName="Generations", fileName="Generations.json")
		#s15 = CardSet(name="XY - XY Trainer Kit", setName="TK", standard=False, shortName="XY Trainer Kit", fileName="XY Trainer Kit.json")
		s16 = CardSet(name="Sun & Moon - Sun & Moon", setName="SUM", standard=False, shortName="Sun & Moon", fileName="Sun & Moon.json")
		s17 = CardSet(name="Sun & Moon - Guardians Rising", setName="GRI", standard=False, shortName="Guardians Rising", fileName="Guardians Rising.json")
		s18 = CardSet(name="Sun & Moon - Burning Shadows", setName="BUS", standard=False, shortName="Burning Shadows", fileName="Burning Shadows.json")
		s19 = CardSet(name="Sun & Moon - Crimson Invasion", setName="CIN", standard=False, shortName="Crimson Invasion", fileName="Crimson Invasion.json")
		...
		s46 = CardSet(name="Sun & Moon - Unbroken Bonds", setName="UNB", standard=True, shortName="Unbroken Bonds", fileName="Unbroken Bonds.json")
		s47 = CardSet(name="Sun & Moon - Unified Minds", setName="UNM", standard=True, shortName="Unified Minds", fileName="Unified Minds.json")
		s48 = CardSet(name="Sun & Moon - Cosmic Eclipse", setName="CEC", standard=True, shortName="Cosmic Eclipse", fileName="Cosmic Eclipse.json")
		s49 = CardSet(name="Sun & Moon - Detective Pikachu", setName="DET", standard=True, shortName="Detective Pikachu", fileName="Detective Pikachu.json")
		s50 = CardSet(name="Sun & Moon - Hidden Fates", setName="HIF", standard=True, shortName="Hidden Fates", fileName="Hidden Fates.json")
		s51 = CardSet(name="Sword & Shield - Sword & Shield", setName="SSH", standard=True, shortName="Sword & Shield", fileName="Sword & Shield.json")		

		s21 = CardSet(name="Sun & Moon - Shining Legends", setName="SLG", standard=False, shortName="Shining Legends", fileName="Shining Legends.json")
		...
		s24 = CardSet(name="XY - XY Black Star Promos", setName="PR-XY", standard=False, shortName="XY Black Star Promos", fileName="XY Black Star Promos.json")
